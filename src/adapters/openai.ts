...
const description = "OpenAI's GPT and o-series models via the OpenAI API.";

const privacyNotes = [
    "American host (limited privacy protections)",
    "Potential risk with WSJ lawsuit",
];

export const openai: Adapter<typeof models> = {
    models,
